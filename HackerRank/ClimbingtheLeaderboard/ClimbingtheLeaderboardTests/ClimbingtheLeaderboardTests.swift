//
//  ClimbingtheLeaderboardTests.swift
...
import XCTest
@testable import ClimbingtheLeaderboard

class ClimbingtheLeaderboardTests: XCTestCase {
    
    func testExample() {
        let solution = Solution()

        
//        let leaderboard = testcase1().0
//        let alicePoints = testcase1().1
//        let res = solution.climbingLeaderboard(scores: leaderboard,
//                                               alice: alicePoints)
        
//        let leaderboard = testcase2().0
//        let alicePoints = testcase2().1
//        let res = solution.climbingLeaderboard(scores: leaderboard,
//                                               alice: alicePoints)
////
        let leaderboard = testcase3().0
        let alicePoints = testcase3().1
        let res = solution.climbingLeaderboard(scores: leaderboard,
                                               alice: alicePoints)

        for number in alicePoints {
            print(number)
        }
        print("----------------------------------------------------")
        for number in res {
